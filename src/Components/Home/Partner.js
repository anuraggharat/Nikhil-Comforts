...
export default function Partner() {
    return (
        <section className="bg-gradient-blue p-5 text-white">
            <div className="container text-center">
                <h1>Partner With us</h1>
            </div>
                <div className="container">
                    <div className="row mt-3 pt-5 px-5">
                        <div className="col-lg-4 text-center px-5">
                            <h4><b>Registered Office</b></h4>
                            <p>1003, R.S. SAMPADA CHS LTD,ARUNODYA NAGAR, MULUND (EAST), MUMBAI-400 081</p>
                        </div>
                        <div className="col-lg-4 text-center  px-5">
                            <h4><b>Sales Office</b></h4>
                ...
                <div className="container text-center">
                <p><b>MR. UDAY RAO | +91 9619876255 | UDAY.RAO@NIKHILCOMFORTS.COM</b></p>
                </div>
        </section>
    )
}
