...
export default function Project() {
    return (
        <div className="pt-5">
            <Jumbotron>
            <h1 className="display-4 font-weight-bold ml-3">Project 1</h1>
                <Breadcrumb>
                <BreadcrumbItem><a href="/">Home</a></BreadcrumbItem>
                <BreadcrumbItem><a href="/projects">All Projects</a></BreadcrumbItem>
                <BreadcrumbItem active>Project 1</BreadcrumbItem>
                </Breadcrumb>
            </Jumbotron>
            <section>
                <div className="container">
                    ...
                    <div className="row">
                            <img className="w-75 h-75" src={Project1} alt="project1" />
                    </div>
                    <div className="row">
